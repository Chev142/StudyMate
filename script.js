        ...
        dashboard.innerHTML = `
            ...
            <div class="tools-section">
                ...
                <div class="tools-grid">
                    <div class="tool-card">
                        <div class="tool-icon flashcards-icon">📚</div>
                        <h3>Flashcards</h3>
                    ...
                    <div class="tool-card">
                        <div class="tool-icon timer-icon">⏰</div>
                    ...
                    <div class="tool-card">
                        <div class="tool-icon quiz-icon">❓</div>
                        <h3>Quiz Maker</h3>
                    ...
                    <div class="tool-card">
                        <div class="tool-icon notes-icon">📝</div>
                        <h3>Notes</h3>
    ...
    addQuizQuestion: function () {
        ...
        const questionHTML = `
            <div class="question-item" data-id="${questionId}">
                ...
                <button class="btn-secondary remove-btn" onclick="this.parentElement.remove()">Remove Question</button>
            </div>
        `;
            ...
            container.innerHTML = quizzes.map(quiz => `
                <div class="quiz-item">
                    ...
                    <div class="quiz-actions">
                        <button onclick="studyMate.takeQuiz(${quiz.id})">Take Quiz</button>
                        <button onclick="studyMate.deleteQuiz(${quiz.id})">Delete</button>
                    </div>
                </div>
            `).join('');
        }
